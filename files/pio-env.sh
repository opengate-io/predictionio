...
PIO_STORAGE_SOURCES_PGSQL_URL=jdbc:postgresql://$POSTGRESQL_DATABASE:5432/postgresql

PIO_STORAGE_SOURCES_PGSQL_USERNAME=$POSTGRESQL_USERNAME
PIO_STORAGE_SOURCES_PGSQL_PASSWORD=$POSTGRESQL_PASSWORD
...
PIO_STORAGE_SOURCES_ELASTICSEARCH_HOSTS=$ELASTICSEARCH_HOSTS
